...
public class Predictor {
    ...
    void initObjGbm() {
        ...
        gbm = GradBooster.createGradBooster(name_gbm);
     ...
     * @return prediction values
     */
    public double[] predict(Map<Integer, Float> feat, boolean output_margin) {
     ...
     * @return prediction values
     */
    public double[] predict(Map<Integer, Float> feat, boolean output_margin, int ntree_limit) {
    ...
    double[] predictRaw(Map<Integer, Float> feat, int ntree_limit) {
     ...
     * @return leaf indexes
     */
    public int[] predictLeaf(Map<Integer, Float> feat) {
